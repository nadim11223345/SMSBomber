...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && cd SMSBomber && python Nbomb.py")
...
def logo():
    ...
    print("│ \033[95mCoder  : Nadim Ahamed               \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mSMSBomber\n")
        time.sleep(0.6)
